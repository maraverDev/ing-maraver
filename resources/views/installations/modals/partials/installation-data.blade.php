<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <select name="place_id" class="form-control @error('place_id') is-invalid @enderror" required>
    ...
    <div class="col-md-4">
        <div class="form-group">
            <label class="form-label fw-bold">Limitadores <span class="text-danger">*</span></label>
            <select name="limiters_installed" id="limitersSelect"
                class="form-control @error('limiters_installed') is-invalid @enderror" {{ old('place_id') ? '' : 'disabled' }} required>
